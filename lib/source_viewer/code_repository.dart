      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              '计数器逻辑运行在独立的 Isolate 中<br> UI 线程通过 SendPort 发送命令<br> Isolate 通过 SendPort 回传状态更新<br> 真正的多线程并行处理，不会阻塞 UI<br> 错误隔离：Isolate 中的错误不会影响主线程',
